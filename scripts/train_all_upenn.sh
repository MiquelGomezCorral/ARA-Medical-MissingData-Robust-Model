...
"python main.py train -mts -mtr --dynamic_dropout --use_radiomics --base_name 'All_masks-D_Dropout'"



run_exp "No Masks - Emb D1 - No Radiomics - No D Dropout" \
"python main.py train --ssl_dataset upenn --base_name 'No_Masks'"




run_exp "All masks - Emb D1 - No Radiomics - No D Dropout" \
"python main.py train --ssl_dataset upenn -mts -mtr --base_name 'All_masks'"


run_exp "All masks - Emb D3 - No Radiomics - No D Dropout" \
"python main.py train --ssl_dataset upenn -mts -mtr --pos_embed 3d --base_name 'All_masks-Emb_D3'"
